...
import os
import getopt
from .bioinfo.process1 import process1_1, process1_2
...
#                self.project['source_file'] = os.path.join(dict['data_dir'], dict['source_file'])
#               self.project['output_file'] = os.path.join(dict['data_dir'], dict['output_file'])
